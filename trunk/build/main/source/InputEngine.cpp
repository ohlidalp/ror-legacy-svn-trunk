...
eventInfo_t eventInfo[] = {
	...
	{ "TRUCK_SAVE_POS1", EV_TRUCK_SAVE_POS1, "Keyboard EXPL+ALT+1", _L("save position as slot 1") },
	{ "TRUCK_SAVE_POS2", EV_TRUCK_SAVE_POS2, "Keyboard EXPL+ALT+2", _L("save position as slot 2") },
	{ "TRUCK_SAVE_POS3", EV_TRUCK_SAVE_POS3, "Keyboard EXPL+ALT+3", _L("save position as slot 3") },
	{ "TRUCK_SAVE_POS4", EV_TRUCK_SAVE_POS4, "Keyboard EXPL+ALT+4", _L("save position as slot 4") },
	{ "TRUCK_SAVE_POS5", EV_TRUCK_SAVE_POS5, "Keyboard EXPL+ALT+5", _L("save position as slot 5") },
	{ "TRUCK_SAVE_POS6", EV_TRUCK_SAVE_POS6, "Keyboard EXPL+ALT+6", _L("save position as slot 6") },
	{ "TRUCK_SAVE_POS7", EV_TRUCK_SAVE_POS7, "Keyboard EXPL+ALT+7", _L("save position as slot 7") },
	{ "TRUCK_SAVE_POS8", EV_TRUCK_SAVE_POS8, "Keyboard EXPL+ALT+8", _L("save position as slot 8") },
	{ "TRUCK_SAVE_POS9", EV_TRUCK_SAVE_POS9, "Keyboard EXPL+ALT+9", _L("save position as slot 9") },
	{ "TRUCK_SAVE_POS10", EV_TRUCK_SAVE_POS10, "Keyboard EXPL+ALT+0", _L("save position as slot 10") },
	
	{ "TRUCK_LOAD_POS1", EV_TRUCK_LOAD_POS1, "Keyboard EXPL+ALT+CTRL+1", _L("load position under slot 1") },
	{ "TRUCK_LOAD_POS2", EV_TRUCK_LOAD_POS2, "Keyboard EXPL+ALT+CTRL+2", _L("load position under slot 2") },
	{ "TRUCK_LOAD_POS3", EV_TRUCK_LOAD_POS3, "Keyboard EXPL+ALT+CTRL+3", _L("load position under slot 3") },
	{ "TRUCK_LOAD_POS4", EV_TRUCK_LOAD_POS4, "Keyboard EXPL+ALT+CTRL+4", _L("load position under slot 4") },
	{ "TRUCK_LOAD_POS5", EV_TRUCK_LOAD_POS5, "Keyboard EXPL+ALT+CTRL+5", _L("load position under slot 5") },
	{ "TRUCK_LOAD_POS6", EV_TRUCK_LOAD_POS6, "Keyboard EXPL+ALT+CTRL+6", _L("load position under slot 6") },
	{ "TRUCK_LOAD_POS7", EV_TRUCK_LOAD_POS7, "Keyboard EXPL+ALT+CTRL+7", _L("load position under slot 7") },
	{ "TRUCK_LOAD_POS8", EV_TRUCK_LOAD_POS8, "Keyboard EXPL+ALT+CTRL+8", _L("load position under slot 8") },
	{ "TRUCK_LOAD_POS9", EV_TRUCK_LOAD_POS9, "Keyboard EXPL+ALT+CTRL+9", _L("load position under slot 9") },
	{ "TRUCK_LOAD_POS10", EV_TRUCK_LOAD_POS10, "Keyboard EXPL+ALT+CTRL+10", _L("load position under slot 10") },
