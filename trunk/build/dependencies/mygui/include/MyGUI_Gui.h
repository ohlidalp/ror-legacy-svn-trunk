...
namespace MyGUI
{
	...
	public:
		...
		*/
		void initialise(Ogre::RenderWindow* _window, const std::string& _core = "core.xml", const std::string & _group = Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME, const Ogre::String logfile = MYGUI_LOG_FILENAME);
