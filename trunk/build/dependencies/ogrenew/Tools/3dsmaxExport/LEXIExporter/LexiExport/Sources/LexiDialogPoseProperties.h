...
#ifndef __NDS_LexiExporter_PosePropertiesDialog__
#define __NDS_LexiExporter_PosePropertiesDialog__

//

class CPosePropertiesDlg : public GDI::Dialog, public IDDNotify
{	
public:
	CPosePropertiesDlg(Window* pParent);	
	~CPosePropertiesDlg();
...
#endif // __NDS_LexiExporter_PosePropertiesDialog__