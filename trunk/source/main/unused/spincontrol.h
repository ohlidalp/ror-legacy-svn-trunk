...
#ifndef __SpinControl_H__
#define __SpinControl_H__
...
namespace Ogre {
    ...
    */
    class  SpinControl : public OverlayContainer
    {
    public:
        /** Constructor. */
        SpinControl(const String& name);
        virtual ~SpinControl();
        ...
        */
		...
		void clickEvent(char* objname);
		float getSpinValue();
		void setSpinValue(float val);
		void setSpinEnable(bool e);
		bool getSpinEnable();
		void spinRedraw();
		bool spinEnabled;
		...
		class _OgrePrivate CmdMinValue : public ParamCommand
        {
        public:
            String doGet(const void* target) const;
            void doSet(void* target, const String& val);
		...
		class _OgrePrivate CmdMaxValue : public ParamCommand
        {
        public:
            String doGet(const void* target) const;
            void doSet(void* target, const String& val);
		...
		class _OgrePrivate CmdPostDot : public ParamCommand
        {
        public:
            String doGet(const void* target) const;
            void doSet(void* target, const String& val);
        };
		class _OgrePrivate CmdUnit : public ParamCommand
        {
        public:
            String doGet(const void* target) const;
            void doSet(void* target, const String& val);
        };
Real preminvalue,premaxvalue,prepostdot;
String preunit;
	protected:
        ...
        static CmdMinValue msCmdMinValue;
        static CmdMaxValue msCmdMaxValue;
        static CmdPostDot msCmdPostDot;
        static CmdUnit msCmdUnit;

		//spincontrol specifics
		TextAreaOverlayElement* taoe[10];
		BorderPanelOverlayElement* bpoe[10];
		BorderPanelOverlayElement* bpoeup[10];
		BorderPanelOverlayElement* bpoedown[10];
		TextAreaOverlayElement* sign;
		TextAreaOverlayElement* unit;
		bool digitpositive;
		int digits[10];
		float minvalue;
		float maxvalue;
...
class SpinControlOverlayElementFactory: public Ogre::OverlayElementFactory
{
   public:
