...
protected:
	...
	static Ogre::RenderWindow *mRenderWindow;
...
public:
	...
	*/
	...
	static void SetOgreRenderWindow (Ogre::RenderWindow *rw);
	...
	*/
	virtual Ogre::String GetOgreHandle ();

	static Ogre::String GetOgreHandleForWindow (wxWindow *w);
