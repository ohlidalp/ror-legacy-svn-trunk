...
class AITraffic_Matrix
{
	public:
		...
		bool inTube(Ogre::Vector3 p1, Ogre::Vector3 p2, float radius, Ogre::Vector3 pos);
		bool intersect(Ogre::Vector3 pa, Ogre::Vector3 pb, Ogre::Vector3 ta, Ogre::Vector3 tb);
