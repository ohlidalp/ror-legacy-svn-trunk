...
void ScriptEngine::init()
{
	...
	result = engine->RegisterObjectMethod("BeamClass", "void resetPosition(float, float, float, bool, float)", asMETHOD(Beam,resetPosition), asCALL_THISCALL); assert_net(result>=0);
