...
void DepthOfFieldEffect::preViewportUpdate(const Ogre::RenderTargetViewportEvent& evt)
{
	...
	/*
	fragParams->setNamedConstant("pixelSizeScene", pixelSizeScene, sizeof(pixelSizeScene)/sizeof(pixelSizeScene[0]), 1.0f);
	fragParams->setNamedConstant("pixelSizeBlur", pixelSizeBlur, sizeof(pixelSizeBlur)/sizeof(pixelSizeBlur[0]), 1.0f);
	fragParams->setNamedConstant("dofParams", dofParams, sizeof(dofParams)/sizeof(dofParams[0]), 1.0f);
	fragParams->setNamedConstant("pixelSize", pixelSize,sizeof(pixelSize)/sizeof(pixelSize[0]), 1.0f);
	*/
