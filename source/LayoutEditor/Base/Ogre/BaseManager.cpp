...
namespace base
{
	...
	bool BaseManager::create()
	{
		...
		Ogre::ResourceGroupManager::getSingleton().addResourceLocation("resources/mygui.zip", "Zip", "General", true);
		Ogre::ResourceGroupManager::getSingleton().addResourceLocation("resources/layouteditor.zip", "Zip", "General", true);
